            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style=" padding: -10%;margin: -70%; ;text-align: left;font-size: 25%;font-weight: 500;">View Details.</p><br><br>
                                </td>
                            </tr>
            ...
            if ($error_1 != '4') {
                echo '
                    ...
                    . '</td>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="padding: 0px; padding-bottom: 5px;margin: -1px; margin-bottom: 5px;text-align: left;font-size: 25px;font-weight: 500;">Edit Doctor Details.</p>
