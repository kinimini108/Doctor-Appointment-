                    ...
                    <center>
                        <table class="filter-container" border="0">
                            <tr>
                                ...
                                <td width="13%">
                                    <input type="submit" name="filter" value=" Filter" class=" btn-primary-soft btn button-icon btn-filter" style="padding: 10px; margin :0;width:100%">
                                    </form>
                                </td>
                            </tr>
                        </table>
    ...
    if ($_GET) {
        ...
        if ($action == 'add-session') {
            echo '
                ...
                <div class="popup">
                <center>
                <a class="close" href="schedule.php">&
